    ...
    <div className="bg-[var(--bg-surface)] border border-[var(--border)] rounded-lg p-6">
      <div className="flex items-center justify-between">
        ...
        >
          ...
          <span className={`text-lg font-semibold ${awayWon ? 'text-[var(--text-primary)]' : 'text-[var(--text-secondary)]'}`}>
            {game.away_team}
          </span>
        </Link>
        ...
        >
          ...
          <span className={`text-lg font-semibold ${homeWon ? 'text-[var(--text-primary)]' : 'text-[var(--text-secondary)]'}`}>
            {game.home_team}
          </span>
        </Link>
      </div>
